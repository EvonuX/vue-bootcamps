  ...
  <v-container>
    <v-layout wrap>
      ...
      <v-col :lg="6" :xs="12">
        ...
        >Your bootcamp does not have courses added, click on the button below to begin.</div>
    ...
    <v-dialog v-model="bootcampDialog">
      <BootcampDialog
        :bootcamp="bootcamp"
        :method="method"
        @closeDialog="bootcampDialog = false"
        @deleteBootcamp="bootcamp = {}"
      />
    </v-dialog>
  </v-container>
</template>
